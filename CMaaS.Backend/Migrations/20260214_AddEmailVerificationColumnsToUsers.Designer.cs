...
namespace CMaaS.Backend.Migrations
{
    ...
    [Migration("20260214_AddEmailVerificationColumnsToUsers")]
    partial class AddEmailVerificationColumnsToUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CMaaS.Backend.Models.ContentEntry", b =>
                {
                    ...
                    b.Property<System.Text.Json.JsonDocument>("Data")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("CMaaS.Backend.Models.ContentType", b =>
                {
                    ...
                    b.Property<System.Text.Json.JsonDocument>("Schema")
                        .IsRequired()
                        .HasColumnType("jsonb");
